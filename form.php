...
$name = $mobile = $message = $sunject = $email = "";
$nameErr = $mobileErr = $messageErr = $sunjectErr = $emailErr  = "";
...
$subject = "Contact 77ADS";
$msg = "Hi, \n\r  My name is :". $name." \n\r Subject :".$subject. " \n\r And My Mobile Number is :".$mobile. " \n\r And My Mail Id is :" .$email. " \n\r Message :" . $message;
$headers = "From: dheeraj@appanalytics.in \r\n";
$headers .= "To: ".$to."\n";
